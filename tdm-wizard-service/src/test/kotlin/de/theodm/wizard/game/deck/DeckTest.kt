...
internal class DeckTest {
    ...
    inner class FullDeck {
        ...
        @Test
        @DisplayName("Enthält alle 4 Zauberer")
        fun enthaeltGenau4Joker() = deckContains(Joker.J1, Joker.J2, Joker.J3, Joker.J4)

        @Test
        @DisplayName("Enthält alle 4 Narren")
        fun enthaeltGenau4Narren() = deckContains(Null.N1, Null.N2, Null.N3, Null.N4)
